...
| Test | Mechanism |
|---|---|
| **Fresh install** | Apply all migrations to an empty database → `atlas schema inspect` → the normalised fingerprint must equal the committed `db/schema.fingerprint` |

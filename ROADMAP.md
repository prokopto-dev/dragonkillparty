...
- Per-strategy golden `BatchProposal` files — four exist (one per planner each, under
  `test/golden/strategy/<id>/`), nine follow their strategies.
